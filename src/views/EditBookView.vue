...
const { book, handleEdit, EditBook, form, handleImageEdit } = useBooks()
    ...
    <v-row justify="center" style="min-height: 100vh">
      <v-col cols="12" md="8" lg="6">
        <v-card class="pa-6 mt-6 rounded-lg" elevation="5">
          <v-card-title class="text-h5 text-center font-weight-bold mb-4">Edit Book</v-card-title>
          ...
          <v-form @submit.prevent="handleEdit">
            ...
            <v-file-input
              ...
              @update:modelValue="handleImageEdit"
            ></v-file-input>
